...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-4 md:bottom-8 left-1/2 -translate-x-1/2 z-50 bg-[#0D0D12]/90 backdrop-blur-xl rounded-[24px] px-3 md:px-5 py-2 md:py-3 flex gap-2 md:gap-3 items-center shadow-2xl border border-white/10 max-w-[95vw] overflow-x-auto ring-1 ring-white/10">
      <Link
        to="/"
      ...
      >
        <Home className={`size-5 md:size-6 ${isActive('/') ? 'text-black' : 'text-gray-300'}`} />
      </Link>
      ...
      >
        <FolderOpen className={`size-5 md:size-6 ${isActive('/projects') ? 'text-black' : 'text-gray-300'}`} />
      </Link>
      ...
      >
        <Lightbulb className={`size-5 md:size-6 ${isActive('/skills') ? 'text-black' : 'text-gray-300'}`} />
      </Link>

      <Link
        to="/about"
        className={`size-[45px] md:size-[50px] rounded-full overflow-hidden flex items-center justify-center transition-all flex-shrink-0 border-2 ${
      ...
      <a
        ...
        className="size-[45px] md:size-[50px] rounded-full bg-[#1F1F26] hover:bg-[#2D2D35] flex items-center justify-center transition-all flex-shrink-0"
      >
        <Github className="size-5 md:size-6 text-gray-400" />
      </a>
      ...
      <a
        ...
        className="size-[45px] md:size-[50px] rounded-full bg-[#1F1F26] hover:bg-[#2D2D35] flex items-center justify-center transition-all flex-shrink-0"
      >
        <Linkedin className="size-5 md:size-6 text-gray-400" />
      </a>
      ...
      <a
        ...
        className="size-[45px] md:size-[50px] rounded-full bg-[#1F1F26] hover:bg-[#2D2D35] flex items-center justify-center transition-all flex-shrink-0"
      >
        <ExternalLink className="size-5 md:size-6 text-gray-400" />
      </a>
    </nav>
  );
}